//! Grammar for the Codegen Lang is defined as follows:
//! ```text
//! <protocol> := <definition>+
//! <definition> :=
...
fn identifier<'src>() -> impl Parser<'src, &'src str, Identifier> {
    text::ident()
...
fn enumeration_field_single_value<'src>() -> impl Parser<'src, &'src str, EnumerationField> {
    let name = identifier();
...
fn enumeration_field_range_of_values<'src>() -> impl Parser<'src, &'src str, EnumerationField> {
    let name = identifier();
    let equals = just('=').padded();
...
fn enumeration_field<'src>() -> impl Parser<'src, &'src str, EnumerationField> {
    choice((
...
fn enumeration_definition<'src>() -> impl Parser<'src, &'src str, Enumeration> {
...
fn structure_field<'src>() -> impl Parser<'src, &'src str, StructureField> {
    let name = identifier();
...
fn structure_definition<'src>() -> impl Parser<'src, &'src str, Structure> {
...
fn union_field<'src>() -> impl Parser<'src, &'src str, UnionField> {
...
fn union_definition<'src>() -> impl Parser<'src, &'src str, Union> {
...
fn type_definition<'src>() -> impl Parser<'src, &'src str, TypeDefinition> {
...
fn definition<'src>() -> impl Parser<'src, &'src str, Definition> {
    choice((
...
fn protocol<'src>() -> impl Parser<'src, &'src str, Protocol> {
    definition()
        .repeated()
